...
public class SecurityConfig {
    ...
    @Value("${finflow.cors.allowed-origins}")
    ...
    // Front (Vite) e back rodam em origens diferentes em dev -- sem isso o
    // preflight OPTIONS do browser é rejeitado antes de qualquer request real chegar.
